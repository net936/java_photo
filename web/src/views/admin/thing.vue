      ...
      >
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="24">
                <a-form-item label="套餐名称" name="title">
              ...
              <a-col span="12">
                <a-form-item label="温馨提示" name="wxts">
                  <a-input placeholder="请输入" v-model:value="modal.form.wxts" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('wxts', modal.form.wxts || '');
